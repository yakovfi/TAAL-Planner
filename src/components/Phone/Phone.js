                ...
                {!flagStress ? <>
                    ...
                    <div className="phoneCoverStress">
                        <div className="phoneHeaderCover">
                            ...
                            {
                                modalOpen ? <>
                                    <div className='pleaseName' style={{ color: "#45350a" }}>,בבקשה</div>
                        ...
                        <div>
                            {modalOpen ? <>
                                <div className='redCoverPhoneStress' style={{ backgroundColor: "#400910" }}  >
                                    <div className='needHelp'
                                    ></div>
                                    <div className='helpContinue' style={{ color: "#3d453e" }}>ממשיך לבקש עזרה</div>
                                </div>
